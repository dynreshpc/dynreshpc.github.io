...
{% include headshot.html image="/assets/headshots/siserte.jpg" caption="Website Chair: Sergio Iserte (BSC)" width="200" height="200" %}
...
If you would like to participate, please sign up to the mailing list.
